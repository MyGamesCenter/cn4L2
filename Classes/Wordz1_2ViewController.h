...
// 120805 sound on/off 3.90 update
//  120829  new card backs.
...
@interface Wordz1_2ViewController : UIViewController 
	...
	IBOutlet UIButton *soundButton;  //120805  ver 3.90
...
// localized strings start here         
         ...
         NSString *hintString, *hintString2; // 3.04 110824         
...
#define TILES_HEIGHT 6
	...
	NSString *tileBackPicImageNM; // file name of back image
     ...
     // 120829  new card backs.
     int imageBackIDX;
     //    UIImage *imageBackA[6];           // cardback image array
     NSString *tileBackPicImageNMa[8]; // cardback image name array
	...
	NSString *gameLanguage; //  CN or EN or whatever. get from phone?
         ...
         UIImage *turnSoundOffImage, *turnSoundOnImage; // 120805
...
@property (nonatomic, retain) IBOutlet UIButton *soundButton;   // 120805
...
// -(void)flipTileInPlace:(int)tfX withY:(int)tfY;     // 110903 removed
